...
### 後續切片(尚未動工,待逐一確認資料源)
- **P3** 融資餘額判讀(接既有孤島模組 `data/capital_flow/margin_change.py`;需融資餘額資料源)
- **P4** 璞玉成分股母池(加「限定母池」來源檔;需 331 檔成分股清單 CSV)
- **P5** 璞玉健康評分 EPS/ROE/股利 3 年連續(需 FinMind 財報資料)
- **P6** 大盤情緒:外資期貨空單(期交所)+ 官股券商分點買超(分點資料源)
- **P7** 璞玉指數 IX0231 每日收盤 + 與大盤相對強弱(TIP 官網)
- **P8** 產業鏈上中下游群體共識判讀(需產業鏈對應表)
