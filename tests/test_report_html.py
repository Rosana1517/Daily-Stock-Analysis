...
"""
        ...
        self.assertIn("前十大主力強度、外資連買與主分點連買", html)
        self.assertIn("MA20 上升、平台突破與融資條件", html)
        self.assertIn("沿用既有流程做觀察補位", html)
        ...
        self.assertIn("isChipRadar(stock)", html)
        self.assertIn("state.filters.chipRadar", html)
